...
- **Ecosystem alignment** — Postgres offers everything we need: a mature vector ecosystem , native support as a [Temporal persistence backend](https://docs.temporal.io/self-hosted-guide/defaults#postgresql) for our workflow orchestration, a proven foundation for our upcoming security infrastructure. 
